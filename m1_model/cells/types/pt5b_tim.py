...
class PT5BFullTimFromPy(CellProvider):
    ...
    def _post(self, netParams):
        ...
        rule['secs']['axon_0']['geom']['pt3d'] = [[-25.435224533081055, 34.14994812011719, 0, 1.6440753936767578],
        ...
        rule['secs']['axon_1']['geom']['pt3d'] = [[63.955810546875, 23.698020935058594, 0, 1.6440753936767578],
    ...
    def import_spec(self, ctx) -> ImportSpec:
        ...
        model_py = (
            self.project_root
            / "cells"
            / "Neuron_Model_12HH16HH_basaldend"
            / "Na12HH_dendModel_TF.py"
        )
        ...
        return ImportSpec(
            ...
            kwargs={
                "cellInstance": True,
                "cellArgs": {
                    "mod_dir": str(model_dir),
                    "params_folder": f"{params_dir}/",
                },
                "somaAtOrigin": True,
            },
            save_to_pkl=None,
