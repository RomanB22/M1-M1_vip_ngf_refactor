...
params = {'weightLong.TPO': (0.3*minChg, 1*maxChg),
          'weightLong.TVL': (0.3*minChg, 1*maxChg),
          'weightLong.S1': (0.3*minChg, 1*maxChg),
          'weightLong.S2': (0.3*minChg, 1*maxChg),
          'weightLong.cM1': (0.3*minChg, 1*maxChg),
          'weightLong.M2': (0.3*minChg, 1*maxChg),
          'weightLong.OC': (0.3*minChg, 1*maxChg),
          ...
          'EICellTypeGain.PV': (1.*minChg, 3.*maxChg),    
          'EICellTypeGain.SOM': (1.*minChg, 3.*maxChg),    
          'EICellTypeGain.VIP': (1.*minChg, 3.*maxChg),    
          'EICellTypeGain.NGF': (1.*minChg, 3.*maxChg),
        #   'scaleDensity': (0.15)   
          }
